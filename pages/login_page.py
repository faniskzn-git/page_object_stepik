...
class LoginPage(BasePage):
    ...
    def should_be_login_url(self):
        assert 'login' in self.browser.current_url, "URL is not available"
    ...
    def register_new_user(self, email, password):
        ...
        self.browser.find_element(*LoginPageLocators.REG_CONFIRM_PASSWORD_FIELD).send_keys(password)
